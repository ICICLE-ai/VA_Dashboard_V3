...
def text2query(request):
    ...
    #     {'input': 'What downstream infrastructures are connected to adjacent infrastructure in Drakes Estero?', 's-expression': '(JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureDownstream_inv https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827)', 's-expression_repr': '(JOIN [is downstream infrastructure of] [Drakes Estero])', 'score': -0.1702354, 'sparql': 'SELECT DISTINCT ?x\nWHERE {\n <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827> <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureDownstream> ?x .\nFILTER (?x != <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827>)\n}', 'results': [('https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_5f26fd',)], 'labels': ['Drakes Bay']},
    #     {'input': 'What downstream infrastructures are connected to adjacent infrastructure in Drakes Estero?', 's-expression': '(JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureAdjacent https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827)', 's-expression_repr': '(JOIN [adjacent infrastructure] [Drakes Estero])', 'score': -1.8577354, 'sparql': 'SELECT DISTINCT ?x\nWHERE {\n?x <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureAdjacent> <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827> .\nFILTER (?x != <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827>)\n}', 'results': [('https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_effb78',)], 'labels': ['Estero de Limantour']},
    #     {'input': 'What downstream infrastructures are connected to adjacent infrastructure in Drakes Estero?', 's-expression': '(JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructure DCTRA)', 's-expression_repr': '(JOIN fsls:infrastructure DCTRA)', 'score': -7.6546106, 'sparql': 'SELECT DISTINCT ?x\nWHERE {\n?x <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructure> "DCTRA" .\n}', 'results': [], 'labels': []},
    #     {'input': 'What downstream infrastructures are connected to adjacent infrastructure in Drakes Estero?', 's-expression': '(JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureIntersect_inv https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_bee8e3)', 's-expression_repr': '(JOIN [intersecting infrastructure] [Drakes Estero State Marine Conservation Area])', 'score': -10.654611, 'sparql': 'SELECT DISTINCT ?x\nWHERE {\n <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_bee8e3> <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureIntersect> ?x .\nFILTER (?x != <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_bee8e3>)\n}', 'results': [('https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_6b0e40',), ('https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827',)], 'labels': ['Point Reyes National Seashore', 'Drakes Estero']},
    #     {'input': 'What downstream infrastructures are connected to adjacent infrastructure in Drakes Estero?', 's-expression': '(JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureAdjacent https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_bee8e3)', 's-expression_repr': '(JOIN [adjacent infrastructure] [Drakes Estero State Marine Conservation Area])', 'score': -12.592111, 'sparql': 'SELECT DISTINCT ?x\nWHERE {\n?x <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureAdjacent> <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_bee8e3> .\nFILTER (?x != <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_bee8e3>)\n}', 'results': [('https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_3b948c',)], 'labels': ['Estero de Limantour State Marine Reserve']},
    #     {'input': 'What downstream infrastructures are connected to adjacent infrastructure in Drakes Estero?', 's-expression': '(JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureDownstream (JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureDownstream_inv https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827))', 's-expression_repr': '(JOIN [downstream infrastructure] (JOIN [is downstream infrastructure of] [Drakes Estero]))', 'score': -16.34375, 'sparql': 'SELECT DISTINCT ?x\nWHERE {\n <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827> <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureDownstream> ?x0 .\n?x <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureDownstream> ?x0 .\nFILTER (?x != <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827>)\n}', 'results': [('https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_effb78',)], 'labels': ['Estero de Limantour']},
    #     {'input': 'What downstream infrastructures are connected to adjacent infrastructure in Drakes Estero?', 's-expression': '(JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureUpstream (JOIN https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureAdjacent https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827))', 's-expression_repr': '(JOIN [upstream infrastructure] (JOIN [adjacent infrastructure] [Drakes Estero]))', 'score': -20.875, 'sparql': 'SELECT DISTINCT ?x\nWHERE {\n?x0 <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureAdjacent> <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827> .\n?x <https://raw.githubusercontent.com/adhollander/FSLschemas/main/fsisupp.owl#infrastructureUpstream> ?x0 .\nFILTER (?x != <https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_725827>)\n}', 'results': [('https://raw.githubusercontent.com/adhollander/FSLschemas/main/CA_PPODterms.ttl#inf_5f26fd',)], 'labels': ['Drakes Bay']}]
    pangu = PanguForPPOD(openai_api_key=openai_api, llm_name='gpt-4-turbo')
    res = pangu.text_to_query(question)
